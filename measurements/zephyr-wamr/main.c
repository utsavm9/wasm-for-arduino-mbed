...
void startTimer(wasm_exec_env_t exec_env)
{
	time_calc_fib = k_uptime_get();
}
...
fail1:
	...
	printf("The time taken for setting up WAMR + finding fib() was %lld milliseconds\n",
...
void main(void)
{
	...
	{
		iwasm_init();
		printf("The time taken was finding fib() in WAMR was %lld milliseconds\n",
		       milliseconds_spent_calc_fib);
	}
	...
	// 	printf("The time taken was finding fib() natively was %lld milliseconds\n",
	// 	       milliseconds_spent_overall);
	// }
	return;
}
